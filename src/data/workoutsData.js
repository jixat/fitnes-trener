...
export const WORKOUTS_DATA = [
  ...
  },
  {
    ...
    duration: '10 мин',
    calories: '100 ккал',
    targetMuscles: ['Спина', 'Руки'],
    defaultSets: 4,
    defaultReps: '8-12',
    restSeconds: 90,
    type: 'video',
    videoPath: '/videos/pullups.mp4',
    demoType: 'pullup',
    description: 'Лучшее упражнение с собственным весом для развития широчайших мышц спины.',
    steps: [
      'Повисните на турнике прямым хватом чуть шире плеч.',
      'На выдохе подтянитесь вверх, сводя лопатки вместе, пока подбородок не окажется над перекладиной.',
      'На вдохе плавно и подконтрольно опуститесь в исходное положение.'
    ],
    proTips: 'Старайтесь тянуть грудь к турнику, а не просто сгибать руки. Не делайте рывков.',
  ...
  },
  {
    ...
    duration: '20 мин',
    calories: '180 ккал',
    targetMuscles: ['Спина', 'Ноги', 'Ягодицы'],
    defaultSets: 4,
    defaultReps: 8,
    restSeconds: 120,
    type: 'video',
    ...
    demoType: 'deadlift',
    description: 'Мощное базовое упражнение, вовлекающее в работу почти все мышцы тела.',
    steps: [
      'Встаньте перед штангой, ноги на ширине таза, гриф над серединой стопы.',
      'Согните ноги и возьмитесь за гриф прямыми руками, спина ровная.',
      'На выдохе поднимите штангу за счет разгибания ног и спины одновременно.',
      'Плавно опустите штангу по той же траектории.'
    ],
    proTips: 'Ни в коем случае не круглите спину! Гриф должен двигаться вплотную к ногам.',
    imageBg: 'linear-gradient(135deg, #be123c 0%, #881337 100%)'
  },
  {
    id: 'glute-bridge',
    ...
    duration: '10 мин',
    calories: '80 ккал',
    targetMuscles: ['Ягодицы', 'Ноги', 'Пресс'],
    defaultSets: 4,
    defaultReps: 20,
    restSeconds: 45,
    type: 'video',
    videoPath: '/videos/glute-bridge.mp4',
    demoType: 'glute-bridge',
    description: 'Эффективное упражнение для изолированной проработки ягодичных мышц.',
    steps: [
      'Лягте на спину, согните ноги в коленях, стопы на полу на ширине таза.',
      'На выдохе оторвите таз от пола и поднимите его максимально вверх, сжимая ягодицы.',
      'Задержитесь на секунду в верхней точке.',
      'На вдохе плавно опустите таз вниз.'
    ],
    proTips: 'Упор должен быть на пятки, а не на носки. Не переразгибайте поясницу.',
    imageBg: 'linear-gradient(135deg, #db2777 0%, #9d174d 100%)'
  }
];
